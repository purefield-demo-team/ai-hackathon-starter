...
const useWebhooks = require("./useWebhooks-vZ20gZ1a.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-vtc-bJWD.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-sJbhyHgA.js.map
