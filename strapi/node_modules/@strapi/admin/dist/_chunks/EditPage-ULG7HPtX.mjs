...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-fKNXOM6C.mjs";
...
import { u as useWebhooks } from "./useWebhooks-6fIt2Avf.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-Zr-6uGLD.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-ULG7HPtX.mjs.map
