...
const ListView$1 = lazy(() => import("./ListView-YRKE3UWQ.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-YRKE3UWQ.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-gReAAkGB.mjs.map
