...
function createRequester(initMiddleware, httpRequest) {
  const loadedMiddleware = [], middleware = middlehooks.reduce(
    ...
    {
      processOptions: [_commonjsHelpers.processOptions],
      validateOptions: [_commonjsHelpers.validateOptions]
    }
  );
...
`), i = 0; i < headersArr.length; i++) {
  ...
  return result;
}, parseHeaders$1 = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(parseHeaders), __defProp = Object.defineProperty, __typeError = (msg) => {
  throw TypeError(msg);
